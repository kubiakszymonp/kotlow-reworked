...
export function UsersPermissionsUserToJSON(json: any): UsersPermissionsUser {
    return UsersPermissionsUserToJSONTyped(json, false);
}

export function UsersPermissionsUserToJSONTyped(value?: UsersPermissionsUser | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
