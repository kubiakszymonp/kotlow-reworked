...
import {
    ...
    UsersPermissionsPermissionsTreeValueControllersValueValueToJSONTyped,
 ...
 */
export function instanceOfUsersPermissionsPermissionsTreeValue(value: object): value is UsersPermissionsPermissionsTreeValue {
    return true;
}
...
export function UsersPermissionsPermissionsTreeValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsersPermissionsPermissionsTreeValue {
    ...
    return {
        ...
        'controllers': json['controllers'] == null ? undefined : json['controllers'],
    };
}

export function UsersPermissionsPermissionsTreeValueToJSON(json: any): UsersPermissionsPermissionsTreeValue {
    return UsersPermissionsPermissionsTreeValueToJSONTyped(json, false);
}

export function UsersPermissionsPermissionsTreeValueToJSONTyped(value?: UsersPermissionsPermissionsTreeValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
