...
export function AuthForgotPasswordPost200ResponseToJSON(json: any): AuthForgotPasswordPost200Response {
    return AuthForgotPasswordPost200ResponseToJSONTyped(json, false);
}

export function AuthForgotPasswordPost200ResponseToJSONTyped(value?: AuthForgotPasswordPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
