...
export function UsersPermissionsRolesPostRequestToJSON(json: any): UsersPermissionsRolesPostRequest {
    return UsersPermissionsRolesPostRequestToJSONTyped(json, false);
}

export function UsersPermissionsRolesPostRequestToJSONTyped(value?: UsersPermissionsRolesPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
