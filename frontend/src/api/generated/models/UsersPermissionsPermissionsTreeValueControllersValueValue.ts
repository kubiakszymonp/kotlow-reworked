...
export function UsersPermissionsPermissionsTreeValueControllersValueValueToJSON(json: any): UsersPermissionsPermissionsTreeValueControllersValueValue {
    return UsersPermissionsPermissionsTreeValueControllersValueValueToJSONTyped(json, false);
}

export function UsersPermissionsPermissionsTreeValueControllersValueValueToJSONTyped(value?: UsersPermissionsPermissionsTreeValueControllersValueValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
